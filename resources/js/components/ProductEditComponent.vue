                ...
                <div id="productinformation-part" class="content" role="tabpanel" aria-labelledby="productinformation-part-trigger">
                    ...
                    <div class="form-group">
                        <select class="form-control" v-model="forms.category"  >
                            <option v-for="categ in this.datasource.category" id="categ">{{categ}}</option>
                        </select>
                    </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                attachment:[],
                categorylist:this.datasource.category,
                forms:{
                    id: this.datasource.iid,
                    name: this.datasource.info.name,
                    category: this.datasource.info.category,
                    description: this.datasource.info.description,
                    dt:null,
                    valid: null,
        ...
        methods: {
            ...
            click_add(id){
                ...
                { 
                    ...
                    axios.post('/api/edit_product_validation',this.forms)
                    .then(function (response){
                        if (response.status === 200) {
                            if (response.data.status == 'success') {
                                stepper.next()
